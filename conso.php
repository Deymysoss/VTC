...
$ordonnee1 = $tableauconso;//températures (ne pas mettre de texte)
$abcisse1 = $tableaudate;//minutes (ne pas mettre de texte)
$titre1 = "Consommation batterie fonction du temps";
$label1 = "Consommation";
$label_abcisse1 = "5 dernieres minutes d'utilisation";
$label_ordonnee1 = "Consommation";
    ...
    <div class="contenu">
        <div class="header">
            ...
            <div class="menu">
                ...
                <input id="btndeconnexion" class="btn" type="button" value="Température du véhicule" onclick="document.location.href='temperature.php';">
            </div>
